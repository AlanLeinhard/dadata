...
class Addres(db.Model):
    __tablename__ = 'fias_addres'
    ID = db.Column(db.Integer, primary_key=True)
    ADRESSTYPE = db.Column(db.String(16), nullable=False)
    ADRESSNAME = db.Column(db.String(16), nullable=False)
    LEVEL = db.Column(db.Integer, nullable=False)
    STREETCODE = db.Column(db.String(3), nullable=False)
...
class House(db.Model):
    __tablename__ = 'fias_addres_house'
    ID = db.Column(db.Integer, primary_key=True)
    HOUSENUM = db.Column(db.String(16), nullable=False)
    HOUSECODE = db.Column(db.String(3), nullable=False)
...
class Kv(db.Model):
    __tablename__ = 'fias_addres_kv'
    ID = db.Column(db.Integer, primary_key=True)
    KVNUM = db.Column(db.String(16), nullable=False)
    KVCODE = db.Column(db.String(3), nullable=False)
